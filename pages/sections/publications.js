...
export default function PublicationsSectionGuide() {
      ...
      },
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Cite it as 'Under review at [Journal Name]' or list as 'Manuscript submitted for publication.' Be honest about the statusâ€”do not claim a paper is published if it's still under review. Update immediately when accepted."
            }
          },
          {
            "@type": "Question",
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "For academic positions (PhD, postdoc, faculty), list all peer-reviewed publications (10-30+). For industry positions, select 3-8 most relevant publications. Quality matters more than quantityâ€”highlight prestigious journals and first-author papers."
    }
  ];
  ...
  const publicationCategories = [
    {
      title: "ðŸ“„ Peer-Reviewed Journal Articles",
      examples: [
        {
    ...
    {
      title: "ðŸ“š Books & Book Chapters",
      examples: [
        {
    ...
    {
      title: "ðŸŽ¤ Conference Papers (Peer-Reviewed)",
      examples: [
        {
    ...
    {
      title: "ðŸŒ Preprints & Under Review (2026 Best Practices)",
      examples: [
        {
  ...
  const careerStages = [
    ...
    { stage: "Undergraduate Student", guidance: "Include research papers, honors theses, conference presentations, and poster sessions. Quality matters more than quantityâ€”highlight your best work." }
  ];
      ...
      <main style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
        ...
        <header>
          ...
          <div style={{ display: 'flex', gap: '20px', marginBottom: '20px', color: '#666', fontSize: '14px', flexWrap: 'wrap' }}>
            ...
            <span>ðŸ“š APA 7th Edition Standards</span>
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '12px' }}>
            <a href="#apa-format" style={{ color: '#0070f3', textDecoration: 'none' }}>â€¢ APA Format (2026)</a>
            <a href="#examples" style={{ color: '#0070f3', textDecoration: 'none' }}>â€¢ Examples by Type</a>
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '16px', color: '#1a1a1a' }}>
            <strong>ðŸ’¡ 2026 Pro Tip:</strong> In multi-author publications, <strong>bold your name</strong> to make it easy for recruiters to identify your contribution. 
            For first-author papers, highlight your name. For corresponding author papers, add an asterisk with a note. Include DOIs for all publicationsâ€”this adds credibility and provides easy access.
          </p>
        </div>
        ...
        <section id="mistakes">
          <h2 style={{ fontSize: '28px', marginBottom: '16px', color: '#1a1a1a', marginTop: '40px' }}>
            âŒ Common Mistakes to Avoid (2026)
          </h2>
          <div style={{ background: '#fff3e0', padding: '20px', borderRadius: '12px', marginBottom: '30px', borderLeft: '4px solid #ff9800' }}>
            <ul style={{ lineHeight: '1.8', margin: 0 }}>
              <li><strong>âŒ Using inconsistent citation formats</strong> - Mixing APA, MLA, and Chicago styles within the same section looks unprofessional</li>
              <li><strong>âŒ Including publications where you're not an author</strong> - Only list your own scholarly work</li>
              <li><strong>âŒ Forgetting to update citations</strong> - Changing "under review" to "published" after acceptance is critical</li>
              <li><strong>âŒ Not highlighting your name</strong> - Your name should stand out in multi-author publications</li>
              <li><strong>âŒ Including predatory journals</strong> - List only reputable, peer-reviewed venues to maintain credibility</li>
              <li><strong>âŒ Missing DOIs or incomplete citations</strong> - Always include full citation information for easy verification</li>
              <li><strong>âŒ Overwhelming non-academic resumes</strong> - For industry roles, limit to 3-5 most relevant publications</li>
            </ul>
          </div>
        </section>
        ...
        <section>
          <h2 style={{ fontSize: '28px', marginBottom: '16px', color: '#1a1a1a', marginTop: '40px' }}>
            ðŸ¤– ATS-Friendly Publication Formatting
          </h2>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            ...
            <Link href="/blog/cv-vs-resume-difference" style={{ color: '#0070f3', textDecoration: 'none', fontWeight: 500 }}>CV vs Resume Guide â†’</Link>
          </div>
        </div>
      </main>
    </>
