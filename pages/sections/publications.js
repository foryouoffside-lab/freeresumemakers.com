...
export default function PublicationsSectionGuide() {
  ...
  const structuredData = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "@id": "https://freeresumemakers.com/sections/publications#article",
        ...
        "image": "https://freeresumemakers.com/images/publications-guide-2026.jpg",
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://freeresumemakers.com/sections/publications"
        },
      ...
      {
        "@type": "HowTo",
        "@id": "https://freeresumemakers.com/sections/publications#howto",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://freeresumemakers.com/sections/publications#faq",
        "mainEntity": [
          {
            "@type": "Question",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Cite it as 'Under review at [Journal Name]' or list as 'Manuscript submitted for publication.' Be honest about the status—do not claim a paper is published if it's still under review. Update immediately when accepted."
            }
          },
          {
            "@type": "Question",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://freeresumemakers.com/sections/publications#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "item": "https://freeresumemakers.com/sections/publications"
          }
        ]
      }
    ]
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "For academic positions (PhD, postdoc, faculty), list all peer-reviewed publications (10-30+). For industry positions, select 3-8 most relevant publications. Quality matters more than quantity—highlight prestigious journals and first-author papers."
    }
  ];
  ...
  const publicationCategories = [
    ...
    {
      title: "🌐 Preprints & Under Review (2026 Best Practices)",
      examples: [
        {
  ...
  const careerStages = [
    ...
    { stage: "Undergraduate Student", guidance: "Include research papers, honors theses, conference presentations, and poster sessions. Quality matters more than quantity—highlight your best work." }
  ];
  ...
  return (
    <>
      <SEO 
        ...
        canonical="https://freeresumemakers.com/sections/publications"
        type="article"
      ...
      <Head>
        ...
        <link rel="canonical" href="https://freeresumemakers.com/sections/publications" />
      </Head>
      ...
      <main style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            ...
            <Link href="/blog/cv-vs-resume-difference" style={{ color: '#0070f3', textDecoration: 'none', fontWeight: 500 }}>CV vs Resume Guide →</Link>
          </div>
        </div>
      </main>
    </>
