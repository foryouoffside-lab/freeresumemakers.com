    ...
    return (
      <>
        ...
        <div style={{
          ...
          >
            â† Back to All Image Section Templates
          </button>
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#0070f3' }}>Photo â€¢ Portfolio â€¢ Branding</div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Link href="/blog/professional-headshot-tips" style={{ color: '#0070f3' }}>Professional Headshot Tips â†’</Link>
            <Link href="/blog/visual-resume-guide" style={{ color: '#0070f3' }}>Guide to Visual Resumes â†’</Link>
            <Link href="/templates/by-section/experience" style={{ color: '#0070f3' }}>Templates with Experience Section â†’</Link>
            <Link href="/blog/personal-branding-resume" style={{ color: '#0070f3' }}>Personal Branding on Your Resume â†’</Link>
          </div>
        </div>
      </div>
    </>
