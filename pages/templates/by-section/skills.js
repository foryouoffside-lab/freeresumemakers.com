        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '14px', color: '#666' }}>Tailor your skills section to match keywords in the job description. This improves ATS compatibility and shows you are a good fit for the role.</p>
            </div>
            <div>
