              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {[
                    ...
                    { feature: 'Experience Badges', t1: 'Ã¢Å“â€œ Yes', t2: 'Ã¢Å“â€œ Yes (type badges)' },
                    { feature: 'Professional Summary Box', t1: 'Ã¢Å“â€œ Yes', t2: 'Ã¢Å“â€œ Yes (executive style)' },
                    { feature: 'Skills Display', t1: 'Grid layout (9 skills)', t2: 'Tags layout (8 skills)' },
                    { feature: 'Languages Section', t1: 'Ã¢Å“â€œ Yes (4 max)', t2: 'Ã¢Å“â€œ Yes (3 max)' },
                    { feature: 'Projects Section', t1: 'Ã¢Å“â€œ Yes', t2: 'Ã¢Å“â€œ Yes (2 max)' },
                    { feature: 'Awards Section', t1: 'Ã¢Å“â€” No', t2: 'Ã¢Å“â€œ Yes (2 max)' },
                    { feature: 'Tools Section', t1: 'Ã¢Å“â€” No', t2: 'Ã¢Å“â€œ Yes (4 max)' },
                  ].map((row, index) => (
          ...
          <div>
            ...
            <div style={{
              ...
              <p style={{ margin: 0, color: '#856404', fontSize: '0.95rem' }}>
                <strong>Ã°Å¸â€œÂ Print Note:</strong> The Executive's dark theme may use more ink when printing. Consider digital submission or test print before mass distribution. The Professional's light theme is more printer-friendly.
              </p>
            </div>
          </div>
        )}
          ...
          <div>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '1.2rem', marginBottom: '10px', color: '#856404' }}>
                Ã°Å¸â€™Â¡ Expert Tip: Consider Your Target Role
              </h3>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ color: '#999' }}>Ã¢Å“â€” May be too senior</div>
                
                <div>Senior Manager (10-15 yrs)</div>
                <div style={{ color: '#0070f3' }}>Ã¢Å“â€œ Great choice</div>
                <div style={{ color: '#1a2634' }}>Ã¢Å“â€œ Also works well</div>
                
                <div>Director (15-20 yrs)</div>
                <div style={{ color: '#999' }}>Ã¢Å“â€” May be too basic</div>
                <div style={{ color: '#1a2634' }}>Ã¢Å“â€œ Excellent choice</div>
                
                <div>VP / C-Suite (20+ yrs)</div>
                <div style={{ color: '#999' }}>Ã¢Å“â€” Not recommended</div>
