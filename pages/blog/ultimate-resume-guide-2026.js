      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              { name: 'Twitter', icon: '🐦', url: `https://twitter.com/intent/tweet?text=${encodeURIComponent('The Ultimate Guide to Writing a Resume in 2026')}&url=https://freeresumemaker.xyz/blog/ultimate-resume-guide-2026` },
              { name: 'LinkedIn', icon: '💼', url: `https://www.linkedin.com/sharing/share-offsite/?url=https://freeresumemaker.xyz/blog/ultimate-resume-guide-2026` },
              { name: 'Facebook', icon: '📘', url: `https://www.facebook.com/sharer/sharer.php?u=https://freeresumemaker.xyz/blog/ultimate-resume-guide-2026` },
              { name: 'Email', icon: '📧', url: `mailto:?subject=${encodeURIComponent('Ultimate Resume Guide 2026')}&body=${encodeURIComponent('Check out this guide: https://freeresumemaker.xyz/blog/ultimate-resume-guide-2026')}` }
            ].map((social, index) => (
              <a
                key={index}
                href={social.url}
