      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              { name: 'Twitter', icon: '🐦', url: `https://twitter.com/intent/tweet?text=${encodeURIComponent('CV vs Resume: Key Differences - Complete Guide 2026')}&url=https://freeresumemaker.xyz/blog/cv-vs-resume-difference` },
              { name: 'LinkedIn', icon: '💼', url: `https://www.linkedin.com/sharing/share-offsite/?url=https://freeresumemaker.xyz/blog/cv-vs-resume-difference` },
              { name: 'Facebook', icon: '📘', url: `https://www.facebook.com/sharer/sharer.php?u=https://freeresumemaker.xyz/blog/cv-vs-resume-difference` },
              { name: 'Email', icon: '📧', url: `mailto:?subject=${encodeURIComponent('CV vs Resume Guide')}&body=${encodeURIComponent('Check out this guide: https://freeresumemaker.xyz/blog/cv-vs-resume-difference')}` }
            ].map((social, index) => (
              <a
                key={index}
                href={social.url}
