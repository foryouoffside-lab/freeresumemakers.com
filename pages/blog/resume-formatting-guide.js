      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              { name: 'Twitter', icon: '🐦', url: `https://twitter.com/intent/tweet?text=${encodeURIComponent('Resume Formatting Guide: Best Practices for 2026')}&url=https://freeresumemaker.xyz/blog/resume-formatting-guide` },
              { name: 'LinkedIn', icon: '💼', url: `https://www.linkedin.com/sharing/share-offsite/?url=https://freeresumemaker.xyz/blog/resume-formatting-guide` },
              { name: 'Facebook', icon: '📘', url: `https://www.facebook.com/sharer/sharer.php?u=https://freeresumemaker.xyz/blog/resume-formatting-guide` },
              { name: 'Email', icon: '📧', url: `mailto:?subject=${encodeURIComponent('Resume Formatting Guide 2026')}&body=${encodeURIComponent('Check out this guide: https://freeresumemaker.xyz/blog/resume-formatting-guide')}` }
            ].map((social, index) => (
              <a
                key={index}
                href={social.url}
