      ...
      <>
        ...
        <div style={{
          ...
          <nav style={{
            ...
            <span>›</span>
            <Link href="/professions/software-engineering" style={{ color: 'var(--text-secondary-light)', textDecoration: 'none' }}>Software Engineering Resumes</Link>
            <span>›</span>
            ...
            <div style={{ marginBottom: '25px' }}>
              ...
              {selectedExample.template.education.map((edu, index) => (
                <div key={index} style={{ marginBottom: '12px' }}>
                  ...
                  {edu.score && <p style={{ color: 'var(--text-secondary-light)' }}>CGPA: {edu.score}</p>}
                </div>
              ))}
            </div>
    ...
    <>
      ...
      <div style={{
        ...
        <nav style={{
          ...
          <Link href="/examples" style={{ color: 'var(--text-secondary-light)', textDecoration: 'none' }}>Resume Examples</Link>
          <span>›</span>
          <span style={{ color: 'var(--primary)', fontFamily: 'var(--font-family-display)' }}>Software Engineering Resumes</span>
        </nav>
        ...
        <div className="premium-card" style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', gap: '24px', marginBottom: '40px', padding: '24px', background: '#f8fafc', flexWrap: 'wrap' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '24px', fontWeight: 'bold', color: 'var(--primary)', fontFamily: 'var(--font-family-display)' }}>React • Node.js • AWS</div>
            <div style={{ fontSize: '14px', color: 'var(--text-secondary-light)' }}>Modern Tech Stack</div>
          </div>
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '24px', fontWeight: 'bold', color: 'var(--primary)', fontFamily: 'var(--font-family-display)' }}>System Design</div>
            <div style={{ fontSize: '14px', color: 'var(--text-secondary-light)' }}>Scalable Architecture</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '14px', color: 'var(--text-secondary-light)' }}>Include links to your GitHub repositories and describe your contributions to open source or personal projects. Recruiters want to see your actual code quality and problem-solving approach.</p>
            </div>
            <div>
              <h3 style={{ fontSize: '16px', marginBottom: '8px' }}>Highlight Modern Technologies</h3>
              <p style={{ fontSize: '14px', color: 'var(--text-secondary-light)' }}>List specific programming languages, frameworks, and tools you are proficient in. Include React, TypeScript, Node.js, Python, AWS, Docker, and Kubernetes to demonstrate current technical expertise.</p>
            </div>
            <div>
              <h3 style={{ fontSize: '16px', marginBottom: '8px' }}>Quantify Achievements with Metrics</h3>
              <p style={{ fontSize: '14px', color: 'var(--text-secondary-light)' }}>Use concrete numbers: "Improved performance by 50%", "Reduced load time from 3s to 0.8s", "Built applications serving 1M+ users", "Mentored 4 junior engineers with 2 promoted".</p>
            </div>
            <div>
              <h3 style={{ fontSize: '16px', marginBottom: '8px' }}>Include System Design and Architecture</h3>
              <p style={{ fontSize: '14px', color: 'var(--text-secondary-light)' }}>Demonstrate your ability to design scalable systems by mentioning microservices architecture, database optimization, caching strategies, and cloud infrastructure you have worked with.</p>
            </div>
          </div>
        </div>
